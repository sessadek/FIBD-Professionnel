@section('meta_desc')
    <meta name="description" content="{{ $id[0]->metadata->meta_description_metaData }}">
    <link rel="canonical" href="{{ url()->current() }}">
@endsection

@section('title')
  {{ $id[0]->metadata->meta_title_metaData }}
@endsection
@section('robots')
  <meta name="robots" content="{{ $id[0]->metadata->index_follow_metaData }}">
@endsection
...
<div class="header__middle--right d-flex d-md-none">
                ...
                <nav aria-label="breadcrumb" class="w-100 d-none d-md-flex">
                    <ol class="breadcrumb col-sm-12 ">
                      ...
                      <?php if($count == count($breadcrumb)-1) break; ?>
                        ...
                        <?php $count++; ?>
                      @endforeach
                        <li class="breadcrumb-item active" aria-current="page">TARIFS ET BILLETTERIE 2019</li>
                    </ol>
                </nav>
                <div class="col-sm-12">
                        ...
                        <div class="buttons-header">
                            <div class="icon-share">
                                <ul class="share-links">
                                  <li><a href="https://twitter.com/bdangouleme?lang=fr" class="link-twitter"><img src="{{ asset('medias/images/Twitter.svg') }}" alt=""></a></li>
                                  <li><a href="https://www.facebook.com/festivalBDangouleme/" class="link-facebook"><img src="{{ asset('medias/images/Facebook.svg') }}" alt=""></a></li>
                                  <li><a href="https://www.instagram.com/bdangouleme/" class="link-instagram"><img src="{{ asset('medias/images/Instagram.svg') }}" alt=""></a></li>
                                </ul>
                            </div>
                            <a href="#" class="icon-print"></a>
                        </div>
                        <div class="h1">TARIFS ET BILLETTERIE 2019</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="container text-center">
            ...
            <div class="h1" id="pass-eo">PASS EARLY OPENING</div>
            ...
            <div class="h1" id="tarifs-uniques">TARIFS UNIQUES</div>
            ...
            <div class="h1" id="tarifs-spectacles">TARIFS SPECTACLES</div>
...
-->							</div>
            ...
            <div class="h1" id="tarifs-scolaires">TARIFS GROUPES SCOLAIRES</div>
            ...
            <div class="h1" id="tarifs-ce">TARIFS COMITÉS D’ENTREPRISES</div>
