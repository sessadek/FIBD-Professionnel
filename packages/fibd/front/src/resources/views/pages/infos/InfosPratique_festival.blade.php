                ...
                <div class="b-festival__body">
                    <div class="b-festival__text">
                        <div class="b-festival__title">
                            ...
                            <img src="{{ asset('medias/images/logo_sncf.png') }}" alt="Venir avec la sncf">
                        </div>
                        <div class="p">
                        ...
                        <div class="b-festival__body--row">
                            <div class="b-festival__body--left">
                                <div class="fz-20">Les arrêts des navettes</div>
                                 <div class="p">Jeudi et Vendredi</div>
                                <ul class="circle">
                                    <li>Gare SNCF</li>
                                    <li>Cité BD</li>
                                    <li>Séminaire</li>
                                ...
                                <div class="p">Samedi et Dimanche</div>
                                <ul class="circle">
                                    <li>Gare SNCF</li>
                                    <li>Cité BD</li>
                                    <li>Séminaire</li>
                            ...
                            <div class="b-festival__body--right">
                                <ul class="fz-20 circle">
                                    <li>Les navettes passent toutes les 6 à 8 minutes</li>
                                    <li>de 9h45 à 19h45 le jeudi</li>
                                    <li>de 9h45 à 19h45 le vendredi</li>
                                    <li>de 9h45 à 20h le samedi</li>
                                    <li>de 9h45 à 18h30 le dimanche</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="b-festival__text">
                        ...
                        <div class="b-festival__text--image">
                            <div class="b-festival--image">
                                <img src="{{ asset('medias/images/logo-effia.jpg') }}" alt="Se stationner avec effia">
                            </div>
