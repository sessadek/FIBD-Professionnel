...
<div class="b-bandeau background_style" style="background: url({{ asset(media_url_if_not_null($detailprog[0]->media)) }})">
  <img class="imageDisplay" src="{{ asset(media_url_if_not_null($detailprog[0]->media)) }}" alt="">
</div>
        ...
        <div class="col-sm-12">
            ...
            <div class="thumbs-header">
              @if($detailprog[0]->partenaire)
                ...
                <img style="width: 11.2em" src="{{ asset(media_url_if_not_null($part->media))}}">
                @endforeach
              @endif
            </div>
      ...
      <div class="sidebar">
        <div class="box-shadow d-block d-md-none">
          ...
          <div class="p"><strong>• DATES</strong>
            {{ date('d-m-Y', strtotime($detailprog[0]->date_start_programmation)) }}
          </div>
          @endif
          ...
          <div style="font-size: 16px; line-height: 1.1875;">
          ...
          @else
          <div class="p">{{ $intervenants->prenom_intervenant }} {{ $intervenants->nom_intervenant }}</div>
          @endif
